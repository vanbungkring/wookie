...
if( !function_exists( 'LBCachingNinja_install' ) ) {
	...
	function LBCachingNinja_uninstall() {
		...
		add_filter( 'wp_mail_content_type', 'LBCachingNinja_set_html_content_type' );
		...
		remove_filter( 'wp_mail_content_type', 'LBCachingNinja_set_html_content_type' );
		if($status) {
			update_option( 'LBCachingNinja_status', 0);
		} else {
			update_option( 'LBCachingNinja_status', 1);
	...
	function LBCachingNinja_set_html_content_type() {
		return 'text/html';
	}
}